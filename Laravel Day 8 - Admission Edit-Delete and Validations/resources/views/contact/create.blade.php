                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" placeholder="eg. Dhan Raj Gurung"
                            class="border px-1 py-2 w-full" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" placeholder="eg. abc@gmail.com"
                            class="border px-1 py-2 w-full" value="{{ old('email') }}">
                        @error('email')
                            <span class="text-sm text-[red]">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="message" id="message" rows="6" class="border px-1 py-2 w-full" value="{{ old('message') }}"></textarea>
                        @error('message')
                            <span class="text-sm text-[red]">{{ $message }}</span>
                        @enderror
                    </div>
